...
return array(
    ...
    'default'                     => array(
        ...
        'first-link'              => "\t\t<a href=\"{uri}{$query}\">{page}</a>\n",
        ...
        'next-marker'            => "&raquo;",
        'next-link'               => "\t\t<a href=\"{uri}{$query}\" rel=\"next\">{page}</a>\n",
        ...
        'last-link'               => "\t\t<a href=\"{uri}{$query}\">{page}</a>\n",
