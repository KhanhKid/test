                ...
                <form role="form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" av id="productName" class="form-control" placeholder="Placeholder" value="<?=isset($brand['value'])?$brand['value']:''?>">
                        </div>
                        <div class="form-group">
                            <label><input type="checkbox" name="status" <?=(isset($brand['status'])&&$brand['status']==1)?'checked':''?> value="1"> 
                                Hiển thị
                            </label>
                        </div>
                    </div>
