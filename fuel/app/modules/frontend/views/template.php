    ...
    <body>
                        ...
                        <div class="col-lg-5 col-md-8">
                            <div class="form">
                                ...
                                <form class="contactForm" id="frm_contact">
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control" name="message" rows="5" data-rule="required" data-msg="Mội dung" placeholder="Message"></textarea>
                                        <div class="validation"></div>
                                    </div>
                                    <div class="form-group">
                                        <div class="g-recaptcha" data-sitekey="6LeoLVAUAAAAAPVVCOt8UJTbrxhMJ7UIvQqKC5i1"></div>
                                    </div>
        ...
        <script>
             $("#frm_contact").on("submit", function(){
                ...
                var formData = $("#frm_contact").serialize();
                $("#frm_contact").hide();
                $.ajax({
                    type: "POST",
