      ...
      <div class="container wow fadeInUp">
        ...
        <div class="row" id="portfolio-wrapper">
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-web">
            <a href="">
              <img src="/assets/frontend/img/portfolio/web2.jpg" alt="">
              <div class="details">
                <h4>Web 2</h4>
                <span>Alored dono par</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-card">
            <a href="">
              <img src="/assets/frontend/img/portfolio/card1.jpg" alt="">
              <div class="details">
                <h4>Card 1</h4>
                <span>Alored dono par</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-card">
            <a href="">
              <img src="/assets/frontend/img/portfolio/card2.jpg" alt="">
              <div class="details">
                <h4>Card 2</h4>
                <span>Alored dono par</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-web">
            <a href="">
              <img src="/assets/frontend/img/portfolio/web3.jpg" alt="">
              <div class="details">
                <h4>Web 3</h4>
                <span>Alored dono par</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-card">
            <a href="">
              <img src="/assets/frontend/img/portfolio/card3.jpg" alt="">
              <div class="details">
                <h4>Card 3</h4>
                <span>Alored dono par</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-logo">
            <a href="">
              <img src="/assets/frontend/img/portfolio/logo1.jpg" alt="">
              <div class="details">
                <h4>Logo 1</h4>
                <span>Alored dono par</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-logo">
            <a href="">
              <img src="/assets/frontend/img/portfolio/logo3.jpg" alt="">
              <div class="details">
                <h4>Logo 3</h4>
                <span>Alored dono par</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-web">
            <a href="">
              <img src="/assets/frontend/img/portfolio/web1.jpg" alt="">
              <div class="details">
                <h4>Web 1</h4>
                <span>Alored dono par</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-logo">
            <a href="">
              <img src="/assets/frontend/img/portfolio/logo2.jpg" alt="">
              <div class="details">
                <h4>Logo 2</h4>
                <span>Alored dono par</span>
              </div>
      ...
      <div class="container wow fadeInUp">
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="psrc="/assets/frontend/img/team-1.jpg" alt=""></div>
              <h4>Walter White</h4>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="psrc="/assets/frontend/img/team-2.jpg" alt=""></div>
              <h4>Sarah Jhinson</h4>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="psrc="/assets/frontend/img/team-3.jpg" alt=""></div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="psrc="/assets/frontend/img/team-4.jpg" alt=""></div>
              <h4>Amanda Jepson</h4>
