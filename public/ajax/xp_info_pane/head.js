...
function showHidePaneContent(e,inputObj)
{
  ...
  if(img.src.toLowerCase().indexOf('_up')>=0){
...
function initDhtmlgoodies_xpPane(panelTitles,panelDisplayed,cookieArray)
{
  ...
  for(var no=0;no<divs.length;no++){
    if(divs[no].className=='dhtmlgoodies_panel'){
      ...
      outerContentDiv.className = ( cookieArray[dhtmlgoodies_paneIndex] == 'pane_img' || cookieArray[dhtmlgoodies_paneIndex] == 'pane_other' ) ? 'panelContentBlack' : 'panelContent';
      ...
      if ( cookieArray[dhtmlgoodies_paneIndex] == 'pane_img' || cookieArray[dhtmlgoodies_paneIndex] == 'pane_other'){
        img.src = '../ajax/xp_info_pane/images/bk-arrow_up.png';
      }else{
        img.src = '../ajax/xp_info_pane/images/arrow_up.png';
      }
      ...
      if(cookieArray[dhtmlgoodies_paneIndex]){
        ...
        if ( cookieNames[dhtmlgoodies_paneIndex] == 'pane_other' ){
            // wws add if
      ...
      if(!panelDisplayed[dhtmlgoodies_paneIndex]){
        ...
        if ( cookieArray[dhtmlgoodies_paneIndex] == 'pane_img' || cookieArray[dhtmlgoodies_paneIndex] == 'pane_other' ){
          img.src = '../ajax/xp_info_pane/images/bk-arrow_down.png';
        }else{
          img.src = '../ajax/xp_info_pane/images/arrow_down.png';
        }
      }

      topBar.className = ( cookieArray[dhtmlgoodies_paneIndex] == 'pane_img' || cookieArray[dhtmlgoodies_paneIndex] == 'pane_other' || cookieArray[dhtmlgoodies_paneIndex] == 'pane_contents' ) ? 'topBarBlack' :'topBar';
